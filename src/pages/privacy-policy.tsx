...
export default function PrivacyPolicy() {
    ...
    return (
        <div className="terms-and-conditions" style={{ padding: `0 ${size.width > 599 ? 84 : 0}px` }}>
            <CustomHeader title="Awake - Privacy Policy" />
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>Interpretation and Definitions</h2>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Awake Media As, Pier X, Bryggegata 3, 0250 Oslo.</p>
                ...
                <li>
                    <p><strong>Facebook Fan Page</strong> is a public profile named Awake specifically created by the Company
                        on the Facebook social network, accessible from <a href="https://www.facebook.com/awakemediaplatform"
                            rel="external nofollow noopener" target="_blank">https://www.facebook.com/awakemediaplatform</a></p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Sale</strong>, for the purpose of the CCPA (California Consumer Privacy Act), means selling,
                        ...
                        another business or a third party for monetary or other valuable consideration.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Service Provider</strong> means any natural or legal person who processes the data on behalf of
                        ...
                        Providers are considered Data Processors.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Awake Media, accessible from <a href="https://www.awake.media"
                        rel="external nofollow noopener" target="_blank">https://www.awake.media</a></p>
                </li>
                <li>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>Collecting and Using Your Personal Data</h2>
            ...
            <p>
                ...
                device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: Cookies: What Do They Do?.
            </p>
            ...
            <ul>
                <li><strong>With Service Providers:</strong> We may share Your personal information with Service Providers to
                    ...
                    Service, to advertise on third party websites to You after You visited our Service, for payment processing,
                    to contact You.</li>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>Detailed Information on the Processing of Your Personal
                Data</h2>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Awake Media</strong></p>
                    <p>Their Privacy Policy can be viewed at <a href="https://www.awake.media/privacy-notice" rel="external nofollow noopener"
                        target="_blank">https://www.awake.media/privacy-notice</a></p>
                </li>
            </ul>
            <h2>Advertising</h2>
            ...
            <ul>
                <li>
                    <p><strong>Awake Media Ad</strong></p>
                    <p>Their Privacy Policy can be viewed at <a href="https://www.awake.media/privacy-notice"
                        rel="external nofollow noopener" target="_blank">https://www.awake.media/privacy-notice</a></p>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    ...
                    <p>For more information on the privacy practices of Mailchimp, please visit their Privacy policy: <a
                        href="https://mailchimp.com/legal/privacy/" rel="external nofollow noopener"
            ...
            <ul>
                <li>
                    ...
                    <p>Their Privacy Policy can be viewed at <a href="https://www.paypal.com/webapps/mpp/ua/privacy-full"
                        rel="external nofollow noopener" target="_blank">https://www.paypal.com/webapps/mpp/ua/privacy-full</a></p>
                </li>
            </ul>
            <p>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>GDPR Privacy</h2>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>Facebook Fan Page</h2>
            ...
            <p>The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the
                Facebook Fan Page <a href="https://www.facebook.com/awakemediaplatform" rel="external nofollow noopener"
                    target="_blank">https://www.facebook.com/awakemediaplatform</a>, the Company and the operator of the social network
                Facebook are Joint Controllers.</p>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>CCPA Privacy</h2>
            ...
            <ul>
                ...
                <li><strong>From Service Providers</strong>. For example, third-party vendors to monitor and analyze the use of
                    our Service, third-party vendors to provide advertising on our Service, third-party vendors to deliver
                    targeted advertising to You, third-party vendors for payment processing, or other third-party vendors that
                    We use to provide the Service to You.</li>
            </ul>
            ...
            <p>Please note that the categories listed below are those defined in the CCPA. This does not mean that all examples
                ...
                value in return.</p>
            <p>We may sell and may have sold in the last twelve (12) months the following categories of personal information:
            </p>
            <ul>
                <li>Category A: Identifiers</li>
                <li>Category B: Personal information categories listed in the California Customer Records statute (Cal. Civ.
            ...
            <ul>
                ...
                <li><strong>The right to request.</strong> Under CCPA, You have the right to request that We disclose
                    ...
                    information. Once We receive and confirm Your request, We will disclose to You:<ul>
                ...
                <li><strong>The right not to be discriminated against.</strong> You have the right not to be discriminated
                    against for exercising any of Your consumer's rights, including by:<ul>
            ...
            <ul>
                <li> By email: <a href="mailto:hello@awakemedia.io" target="_blank" rel="noreferrer">hello@awakemedia.io</a> </li>
            </ul>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>"Do Not Track" Policy as Required by California Online
                Privacy Protection Act (CalOPPA)</h2>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>Children's Privacy</h2>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>Your California Privacy Rights (California's Shine the
                Light law)</h2>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>California Privacy Rights for Minor Users (California
                Business and Professions Code Section 22581)</h2>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>Links to Other Websites</h2>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>Changes to this Privacy Policy</h2>
            ...
            <h2 style={{ marginBottom: 10, fontSize: 28 }}>Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, You can contact us:</p>
            <ul>
                <li style={{ paddingBottom: 32 }}> By email: <a href="mailto:hello@awakemedia.io" target="_blank" rel="noreferrer">hello@awakemedia.io</a> </li>
            </ul>
        </div>
    );
}
