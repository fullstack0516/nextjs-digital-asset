...
export default function TermsAndConditions() {
    ...
    return (
        <div className="terms-and-conditions" style={{ padding: `0 ${size.width > 599 ? 84 : 0}px` }}>
            <CustomHeader title="Awake - Terms and conditions" />
            ...
            <ul>
                ...
                <li><strong> Company </strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
                    refers to Awake Media As, Pier X, Bryggegata 3, 0250 Oslo.</li>
                <li><strong> Content </strong> refers to content such as text, images, or other information that can be posted,
                ...
                <li><strong> Device </strong> means any device that can access the Service such as a computer, a cellphone or a
                    digital tablet. </li>
                <li><strong> Feedback </strong> means feedback, innovations or suggestions sent by You regarding the attributes,
                ...
                <li><strong> Promotions </strong> refer to contests, sweepstakes or other promotions offered through the
                    Service. </li>
                <li><strong> Service </strong> refers to the Website. </li>
                <li><strong> Terms and Conditions </strong> (also referred as "Terms") mean these Terms and Conditions that form
                    the entire agreement between You and the Company regarding the use of the Service. </li>
                ...
                <li><strong> Website </strong> refers to Awake Media, accessible from <a href="https://www.awake.media" target="_blank"
                    rel="noreferrer">https://www.awake.media</a> </li>
            ...
            <p> The Company reserves the right, but not the obligation, to, in its sole discretion, determine whether or not any
                ...
                the right to make formatting and edits and change the manner any Content. The Company can also limit or revoke
                the use of the Service if You post such objectionable Content. As the Company cannot control all content posted
                by users and/or third parties on the Service, you agree to use the Service at your own risk. You understand that
                by using the Service You may be exposed to content that You may find offensive, indecent, incorrect or
                objectionable, and You agree that under no circumstances will the Company be liable in any way for any content,
                including any errors or omissions in any content, or any loss or damage of any kind incurred as a result of your
            ...
            <p> If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been
                ...
                submit Your notice in writing to the attention of our copyright agent via email at <a
                    href="mailto: hello@awakemedia.io" target="_blank" rel="noreferrer"> hello@awakemedia.io</a> and include in Your
            ...
            <p>You can contact our copyright agent via email at <a href="mailto: hello@awakemedia.io" target="_blank"
                rel="noreferrer"> hello@awakemedia.io.</a> Upon receipt of a notification, the Company will take whatever action,
